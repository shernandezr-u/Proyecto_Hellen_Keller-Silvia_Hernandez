...
|----|----------------|----------------------------|
| **RF-01** | El sistema debe permitir que los usuarios inicien sesión utilizando correo electrónico. | Se verifica que el formulario de inicio de sesión acepte el correo electrónico y valide los formatos de entrada. |
...
| **RF-04** | El administrador podrá registrar nuevos programas o terapias. | Al registrar un programa, debe guardarse correctamente en la base de datos y mostrarse en la lista de programas/terapias. |
| **RF-05** | El administrador podrá editar programas/terapias existentes. | Las modificaciones deben reflejarse inmediatamente en la interfaz y la base de datos. |
...
| **RF-08** | El docente o terapeuta podrá crear Planes Educativos Individualizados (PEI) para sus estudiantes. | Los PEI creados deben almacenarse correctamente en la base de datos. |
...
| **RF-10** | El docente podrá registrar el progreso del estudiante mediante el porcentaje de avance. | El sistema debe permitir agregar el porcentaje de avance en el PEI y guardar la información en la base de datos. |
