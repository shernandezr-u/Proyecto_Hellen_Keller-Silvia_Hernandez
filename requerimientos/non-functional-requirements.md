...
| **RNF-04** | Todos los elementos deben ser navegables mediante teclado. | Pruebas de accesibilidad deben confirmar que se puede acceder a todas las funciones con uso de flechas. |
...
| **RNF-09** | El sistema debe ser responsivo y adaptarse a dispositivos móviles y computadoras. | Pruebas de diseño adaptable deben mostrar correcta visualización y funcionalidad en resoluciones de celular y desktop/laptop. |